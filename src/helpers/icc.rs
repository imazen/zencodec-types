...
mod tests {
    ...
    fn format_scenarios() {
        let cases: &[FormatScenario] = &[
            ("jpeg_no_icc", PixelFormat::Rgb8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("jpeg_unknown_icc", PixelFormat::Rgb8, sc_icc(0xCA, 3144), None, TF::Unknown, CP::Unknown),
            ("jpeg_corrected", PixelFormat::Rgb8, sc_icc(0xCA, 3144), Some(Cicp::SRGB), TF::Srgb, CP::Bt709),
            ("png_cicp_p3", PixelFormat::Rgba8, sc_cicp(Cicp::DISPLAY_P3), None, TF::Srgb, CP::DisplayP3),
            ("png_cicp_over_icc", PixelFormat::Rgba8, sc_cicp_icc(Cicp::DISPLAY_P3, 0, 100), None, TF::Srgb, CP::DisplayP3),
            ("png_no_metadata", PixelFormat::Rgba8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("png_hdr_pq", PixelFormat::Rgba16, sc_cicp(Cicp::BT2100_PQ), None, TF::Pq, CP::Bt2020),
            ("webp_no_icc", PixelFormat::Rgba8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("webp_unknown_icc", PixelFormat::Rgba8, sc_icc(0xA3, 480), None, TF::Unknown, CP::Unknown),
            ("avif_srgb", PixelFormat::Rgba8, sc_cicp(Cicp::SRGB), None, TF::Srgb, CP::Bt709),
            ("avif_hdr10", PixelFormat::RgbaF32, sc_cicp(Cicp::BT2100_PQ), None, TF::Pq, CP::Bt2020),
            ("avif_hlg", PixelFormat::RgbF32, sc_cicp(Cicp::BT2100_HLG), None, TF::Hlg, CP::Bt2020),
            ("avif_p3", PixelFormat::Rgb8, sc_cicp(Cicp::DISPLAY_P3), None, TF::Srgb, CP::DisplayP3),
            ("jxl_srgb", PixelFormat::Rgb8, sc_cicp(Cicp::SRGB), None, TF::Srgb, CP::Bt709),
            ("jxl_p3_pq", PixelFormat::RgbaF32, sc_cicp(Cicp::new(12, 16, 0, true)), None, TF::Pq, CP::DisplayP3),
            ("heic_p3", PixelFormat::Rgba8, sc_cicp(Cicp::DISPLAY_P3), None, TF::Srgb, CP::DisplayP3),
            ("heic_hdr10", PixelFormat::RgbaF32, sc_cicp(Cicp::BT2100_PQ), None, TF::Pq, CP::Bt2020),
            ("gif_srgb", PixelFormat::Rgba8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("bmp_srgb", PixelFormat::Rgb8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("pnm_gray", PixelFormat::Gray8, sc_none(), None, TF::Srgb, CP::Bt709),
            ("tiff_unknown_icc", PixelFormat::Rgb16, sc_icc(0x54, 7261), None, TF::Unknown, CP::Unknown),
            ("tiff_no_icc", PixelFormat::Rgb16, sc_none(), None, TF::Srgb, CP::Bt709),
        ];
