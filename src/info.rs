...
impl SourceColor {
    ...
    /// analysis (primaries matrix comparison via zencodecs) for the long tail.
...
/// FNV-1a 64-bit hash. Deterministic across all platforms, no_std, const-capable.
...
/// See `tests/icc_srgb.rs` for verification against the actual profile files.
